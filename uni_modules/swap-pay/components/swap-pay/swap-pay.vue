...
<script>
	// 引入支付云对象
	const uniPayCo = uniCloud.importObject("swap-pay-co");
	...
	export default {
		...
		async mounted() {
			...
			if (!myOpenid) {
				...
				let provider_appid = accountInfo.miniProgram.appId
		...
		methods: {
			...
			async createOrder(data = {}) {
				...
				createOrderData.provider_appid = appId;
				// #endif
			...
			paySuccess(res={}) {
				...
				this.clearQrcode();
				console.log(this.toSuccessPage)
